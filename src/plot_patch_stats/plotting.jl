...
ax = Axis(fig[1, 1], xlabel = L"Log(Area \ (m^2))", ylabel = "Number of patches", title = "Joulters Cays",
          limits = (x_min, x_max, 0, y_max_Joulters))
#ax2 = Axis(fig[1, 2], xlabel = L"Log(Area \ (m^2))", ylabel = "Numbers", title = "Joulters Cay 2019",
#           limits = (x_min, x_max, 0, y_max_Joulters))
ax3 = Axis(fig[1, 2], xlabel = L"Log(Area \ (m^2))", ylabel = "Number of patches", title = "North Abacos",
           limits = (x_min, x_max, 0, y_max_Abacos))
#ax4 = Axis(fig[2, 2], xlabel = L"Log(Area \ (m^2))", ylabel = "Numbers", title = "Abacos 2019",
#           limits = (x_min, x_max, 0, y_max_Abacos))
...
fig
save("seagrass_histograms.png", fig)
...
for i in 1:nbins
    ...
    bin_end   = bin_edges[i+1]
       ...
       elseif count_J_1945 == 0
           push!(prop_J_change, count_A_2019 * 100.0)
       else
...
ax6 = Axis(fig3[1, 1], xlabel = L"ED_i", ylabel = "Number of patches", title = "Joulters Cays", limits = (0, 0.8, 0, 170))
#ax7 = Axis(fig3[1, 2], xlabel = L"ED_i", ylabel = "Number", title = "Joulters Cay 2019", limits = (0, 0.8, 0, 170))
ax8 = Axis(fig3[1, 2], xlabel = L"ED_i", ylabel = "Number of patches", title = "North Abacos", limits = (0, 0.6, 0, 870))
#ax9 = Axis(fig3[2, 2], xlabel = L"ED_i", ylabel = "Number", title = "Abacos 2019", limits = (0, 0.6, 0, 870))
...
#       axislegend(ax9)      
fig3
save("seagrass_ED_histograms.png", fig3)
